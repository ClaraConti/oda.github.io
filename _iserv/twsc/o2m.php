<?php
	...
	$BACKUP_ORDER	= true;		
	$MERCHANT_TO	= "<73904391@continental.edu.pe>";		
	$MERCHANT_FROM	= "<73904391@continental.edu.pe>";	
	$MERCHANT_BCC 	= true;		
	$MERCHANT_DATE_FORMAT = "dd/mm/yyyy";	
	$CRLF 			= "\r\n";				
	$HTTP_PREFIX	= (false)?'https://':'http://';		
	$VO_CTR = "68fd91fef86391757ec02b16ca108317";					
	$MAX_PERIOD = -1;				
	$ORDER_EMAIL_ADD_URL = false;		
	$ACCOUNTS_URL = "";
	$COOKIE_ACCOUNT_INF = "c138-account_inf";
